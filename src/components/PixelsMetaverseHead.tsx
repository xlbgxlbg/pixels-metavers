...
class PixelsMetaverseHead extends React.Component<any, any> {
  // @ts-ignore
  ...
  public render = () => {
    ...
    return (
      <div className="bg-transparent" style={{ overflow: "auto", minWidth: 1200, height: 60 }}>
        <Header
          connected={connected}
          address={address}
          chainId={chainId}
...
export default PixelsMetaverseHead;